...
public class TabFragment extends Fragment {
   ...
   // RecyclerView.LayoutManager layoutManager=new LinearLayoutManager(getContext());
    //protected List<NewsObject> list=new ArrayList<NewsObject>();
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        if(null!=view)
        {
            ...
            view=inflater.inflate(R.layout.frament_t, container, false);
            initView();
        }
    ...
    private void initView() {
        ...
        RecyclerView recyckerView=(RecyclerView)view.findViewById(R.id.f1);
   ...
   /* public static <T> ArrayList<T> jsonToArrayList(String json, Class<T> clazz)
    ...
    private void initDate()
    {
       ...
       // List<NewsObject> ls=new ArrayList<NewsObject>();
        String url="http://192.168.43.156:8081/AndroidSever/getnews.php";
